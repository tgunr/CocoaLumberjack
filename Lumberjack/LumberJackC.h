...
//  LumberJack
//
//  Created by Dave Carlton on 7/9/12.
//
//

#ifndef LumberJack_LumberJackC_h
#define LumberJack_LumberJackC_h
...
#define PMHEREC ASYNC_LOG_C_MAYBE(ddLogLevel, LOG_FLAG_DEBUG, 2, @"")
